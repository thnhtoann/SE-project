...
const IconShoppingBag: FC<IconShoppingBagProps> = ({ className, fill = false }) => {
    return (
        <>
            {fill ? (
                <svg width="20" height="20" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" className={className}>
                    <path
                        opacity="0.5"
                        d="M9 6V5C9 3.34315 10.3431 2 12 2C13.6569 2 15 3.34315 15 5V6.5C15 6.77614 14.7761 7 14.5 7H9.5C9.22386 7 9 6.77614 9 6.5V6Z"
                        fill="currentColor"
                    />
                    <path
